...
function ChartComponent({ title = "Chart Title" }) {
  return (
    <div className="bg-white shadow-lg rounded-xl p-4 border border-gray-200 flex flex-col hover:shadow-xl transition-shadow duration-300 ease-in-out min-h-[200px] sm:min-h-[250px]">
